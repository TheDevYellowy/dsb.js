...
class SnowflakeUtil extends null {
  ...
  static deconstruct(snowflake) {
    ...
    return {
      timestamp: parseInt(bigIntSnowflake >> 22n) + EPOCH,
      get date() {
        return new Date(this.timestamp);
      },
      workerId: parseInt((bigIntSnowflake >> 17n) & 0b11111n),
      processId: parseInt((bigIntSnowflake >> 12n) & 0b11111n),
      increment: parseInt(bigIntSnowflake & 0b111111111111n),
      binary: bigIntSnowflake.toString(2).padStart(64, '0'),
    };
  }

  /**
   * Retrives the timestamp field's value from a Discord snowflake.
